...
AppData.prototype.getTargetMonth = function () { // Подсчитываем за какой период будет достигнута цель, зная результат месячного накопления и записывает результат в обьект
    return Math.ceil(targetAmount.value / this.budgetMonth);
};

AppData.prototype.getStatusIncome = function () { // Метод Определяет уровень дохода пользователя 
...
AppData.prototype.moveRange = function () {
    this.period = periodSelect.value;
    periodAmount.textContent = this.period;
}

AppData.prototype.checkingCompletion = function () {
...
AppData.prototype.myEvenetListeners = function () {
